    ...
    <div class="container">
      <h2 style="text-align: center"><u>Appointments</u></h2>
        ...
        <?php
          ...
          $sql = "SELECT id, description, title, start, endT, resourceId, hyg FROM patappts WHERE dentist = '" . $name . "'";
          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              while($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>" . $row['id'] . "</td><td>" . $row['title'] . "</td><td>" . $row['description'] .  "</td><td>" . $row['start'] . "</td><td>" . $row['endT'] . "</td><td>" . $row['hyg'] . "</td></tr>";
              }
              echo "</table>";
            } else {
